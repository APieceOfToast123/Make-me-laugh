...
public class RemovingState : IBuildingState
{
    ...
    public void OnAction(Vector3Int gridPosition)
    {
        ...
        previewSystem.UpdatePosition(cellPosition, Vector3.zero, CheckIfSelectionIsValid(gridPosition));
    }
    ...
    public void UpdateState(Vector3Int gridPosition)
    {
        ...
        previewSystem.UpdatePosition(grid.CellToWorld(gridPosition), Vector3.zero, validity);
    }
}
